...
execute as @e[scores={ft_player_set=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Tags:[ft_player_flag]}}}] run playsound minecraft:entity.player.levelup player @s
...
execute as @e[scores={ft_cancel_set=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Tags:[ft_cancel_flag]}}}] run playsound minecraft:entity.player.levelup player @s
...
execute as @e[scores={ft_point_set=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Tags:[ft_point_flag]}}}] run playsound minecraft:entity.player.levelup player @s
